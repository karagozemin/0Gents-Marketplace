...
export interface SimpleINFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface SimpleINFT extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleINFT;
  waitForDeployment(): Promise<this>;

  interface: SimpleINFTInterface;
